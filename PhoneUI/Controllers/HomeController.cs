...
namespace PhoneUI.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            #region Banner
            var list = db.com_banner.Where(b => b.com_banner_class == "手机首页").OrderByDescending(b => b.com_banner_order).ToList();
            ...
            var list2 = db.com_banner.Where(b => b.com_banner_class == "首页超高压2.0电饭煲系列").Take(4).OrderByDescending(b => b.com_banner_order).ToList();
            ...
            ViewBag.jhqadurl = new Uri(db.com_banner.Where(b => b.com_banner_class == "首页净化器广告").SingleOrDefault().com_banner_url).AbsolutePath; ;
            ...
            ViewBag.yzjadurl =new Uri(db.com_banner.Where(b => b.com_banner_class == "首页原汁机广告").SingleOrDefault().com_banner_url).AbsolutePath;
            ...
            ViewBag.ztjadurl = new Uri(db.com_banner.Where(b => b.com_banner_class == "首页重汤机广告").SingleOrDefault().com_banner_url).AbsolutePath;
            ...
            ViewBag.dkpadurl = new Uri(db.com_banner.Where(b => b.com_banner_class == "首页电烤盘广告").SingleOrDefault().com_banner_url).AbsolutePath;
            ...
            ViewBag.dshadurl = new Uri(db.com_banner.Where(b => b.com_banner_class == "首页电水壶广告").SingleOrDefault().com_banner_url).AbsolutePath;
        ...
        public JsonResult Ad()
        {
            try
            {
                ...
                var ss = db.ad_info.Where(a => a.ad_type == "ph").OrderBy(s => s.ad_date).ToList();
